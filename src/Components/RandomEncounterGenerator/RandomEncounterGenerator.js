    ...
    constructor(props) {
        ...
        this.encounterMap = {
            ...
            "Yellow musk creeper and yellow musk zombies": [
                <h4>Yellow musk creeper and yellow musk zombies</h4>,
        ...
        return (
            <div className="RandomEncounterGenerator">
                ...
                <div>
                    ...
                    <br></br>
                    <a href="https://www.dndbeyond.com/encounter-builder"><b>Encounter builder</b></a>
                </div>
            </div>
        );
    }
